...
namespace datetime_ve_math_siniflari
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.ToLongTimeString());     //saat,dk,saniye
            ...
            Console.WriteLine("**** Math Kütüphaneis ****");
            //Math Kütüphanesi
            Console.WriteLine(Math.Abs(-25)); //Mutlak değer alır (- değeri + çevirmek için)
            ...
            Console.WriteLine(Math.Round(22.7));    // 23 ( yuvarlar)
            ...
            Console.WriteLine(Math.Log10(10));      //10 sayısının logaritma 10 tabanındaki karşığını verir.
